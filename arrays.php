...
$menuItems = array(
  ...
  "club-sandwich" => array(
    "title" => "club-sandwich",
    "price" => 11,
    "blurb" => "Bacon ipsum dolor amet ad laboris qui chuck picanha in pastrami ipsum pig ribeye mollit bresaola labore sint ground round. Mollit elit ad sausage strip steak pork chop. Culpa proident jerky aliquip ham occaecat, shankle et t-bone incididunt nostrud laborum. Kevin swine drumstick pariatur cupidatat.",
      "drink"=> "Club Soda"
  ),
  "dill-salmon" => array(
...
// <sup> tag makes the text inside it float small and above
